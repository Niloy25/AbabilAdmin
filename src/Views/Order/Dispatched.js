...
import OrderDeliverModal from "../../Component/Modal/OrderDeliverModal";
...
export default function Dispatched() {
  ...
  return (
    <>
            ...
            {loop.map((item) => {
              return (
                <div className="frthRow mt-4">
                  ...
                  <div className="col-lg-3 col-md-12 col-12 rgtcntFoeMD">
                    <div style={{ padding: "16px 0", textAlign:"right" }}>
                      <button>Bulk order</button>
                      <span style={{ whiteSpace: "nowrap", fontSize: "13px", display:"block" }}>
                        Dispatched on 16/10/2021
                      </span>
                      <div className="dispatchBtn" style={{marginTop:"45px"}}>
                        <a onClick={()=>{setModal4(true)}} style={{cursor:"pointer"}}>Mark as delivered</a>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      {modal4 && (<OrderDeliverModal handleClickClose={handleClickClose3} />)}
    </>
  );
}
