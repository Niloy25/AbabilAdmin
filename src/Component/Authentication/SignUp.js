...
function SignUp() {
    ...
    const handleValidation = () => {
        const { firstname, lastname, email, password, mobile, country, state, city, addressLine1, addressLine2, zipcode, bussinessName, panNumber, tradeNumber, accountHolderName, accountNumber, branchName, IFSCcode } = registerData;
    ...
    const handleSubmit = async() => {
        if(handleValidation()){
            const result = await requestData('distributor/register', "POST", registerData)
            console.log(result);
                    ...
                    <div className="sign_up_form">
                                ...
                                <div className="form-box">
                                    <div className="form-group">
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => setRegisterData({ ...registerData, addressLine2: e.target.value })}
                                        />
                                ...
                                <div className="form-box">
                                    <div className="form-group">
                                        ...
                                        <input
                                            ...
                                            aria-describedby="emailHelp"
                                            placeholder="Enter your address"
                                            onChange={(e) => setRegisterData({ ...registerData, addressLine1: e.target.value })}
                                        />
                                ...
                                <div className="form-box">
                                    <div className="form-group">
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => setRegisterData({ ...registerData, bussinessName: e.target.value })}
                                        />
                                    </div>
                                </div>
                                <div className="form-box">
                                    <div className="form-group">
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => setRegisterData({ ...registerData, tradeNumber: e.target.value })}
                                        />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="row align-items-start mb-5">
                            ...
                            <div className="col-lg-4 col-xl-4 col-md-4  col-12">
                                <div className="form-box">
                                    <div className="form-group">
                                        <label htmlFor="exampleInputEmail1">Account Holder name</label>
                                        <input
                                            type="text"
                                            className="form-control form-input"
                                            id="exampleInputEmail1"
                                            ...
                                            onChange={(e) => setRegisterData({ ...registerData, accountHolderName: e.target.value })}
                                        />
                                    </div>
                                </div>
                                <div className="form-box">
                                ...
                                <div className="form-box">
                                    <div className="form-group">
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => setRegisterData({ ...registerData, IFSCcode: e.target.value })}
                                        />
                ...
                <div className='container'>
                    ...
                    <div className="col-lg-8 col-xl-8 col-md-8  col-12">
                        <div className="form-box">
                            ...
                            />
                            <p>I agree to the Terms & Conditions and Privacy Policy of Ababil Books . I would be held responsible if I sell pirated books or
                                illegal prints.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div lassName="col-lg-8 col-xl-8 col-md-8  col-12">
                        <div className='apply'>
                            {/* <Link to='/confirmation'> */}
                                <button onClick={handleSubmit} className='approval'>Apply for approval</button>
                            {/* </Link> */}
                        </div>
                    </div>
                </div>
